...
using Web_Services.IAM.Domain.Model.Queries;
using Web_Services.IAM.Domain.Services;
using Web_Services.IAM.Infrastructure.Pipeline.Middleware.Attributes;

namespace Web_Services.IAM.Infrastructure.Pipeline.Middleware.Components;
...
public class RequestAuthorizationMiddleware(RequestDelegate next)
{
        ...
        ITokenService tokenService)
    {
        ...
        context.Items["UserAccount"] = user;
